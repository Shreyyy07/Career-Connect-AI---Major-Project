...
import { User, Mail, Shield, Save, Lock, Eye, EyeOff, Camera, CheckCircle2, Building, Activity } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div className="w-full mt-6 space-y-3 text-left">
                {[
                  { icon: Building, label: "Company", value: user?.companyName || "Organization", color: "text-emerald-400" },
                  { icon: Activity, label: "Dashboard", value: "View KPIs", color: "text-[#00e5ff]" },
            ...
            <div className="lg:col-span-2 space-y-5">
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">How you appear to candidates and on job postings</p>
                  </div>
                </div>
              ...
              >
                <h3 className="font-display font-semibold text-foreground mb-3 text-sm uppercase tracking-wider text-muted-foreground">Company Info</h3>
                <div className="space-y-2">
                  {[
                    { label: "Organization", value: user?.companyName || "Not Provided" },
                    { label: "Account Type", value: user?.role === "hr" ? "Recruiter" : "Unknown" },
                    { label: "Account Status", value: "Verified & Active", color: "text-emerald-400" },
